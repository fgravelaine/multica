...
const PAGE_KEYWORDS: Record<WorkspacePageKey, string[]> = {
  ...
  // SPIKE (not upstream): the mission index. "tree", "canvas" and "waiting"
  // are here because they are what someone types when they remember what the
  // view DOES and not what it is called.
  missions: ["missions", "mission", "tree", "canvas", "map", "waiting", "任务图", "地图"],
