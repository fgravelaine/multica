...
const PAGE_KEYWORDS: Record<WorkspacePageKey, string[]> = {
  ...
  // SPIKE (not upstream): the ladder. "missions", "tree" and "waiting" are
  // here because they are what someone types when they remember what the view
  // DOES and not what it is called.
  campaigns: ["campaigns", "campaign", "missions", "mission", "objectives", "tasks", "tree", "canvas", "map", "waiting", "orphan", "任务图", "地图"],
